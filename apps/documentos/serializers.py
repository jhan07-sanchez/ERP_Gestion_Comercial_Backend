...
"""
Serializers para el módulo centralizado de Documentos ERP.
"""
...
class DocumentoDetalleSerializer(serializers.ModelSerializer):
    """Serializer para el snapshot de líneas del documento."""
    class Meta:
        model = DocumentoDetalle
        fields = [
            'id', 'orden', 'descripcion', 'producto_id',
...
class DocumentoListSerializer(serializers.ModelSerializer):
    """
    Serializer optimizado para el listado centralizado.
    Muestra información básica y la entidad relacionada (Cliente/Proveedor).
    """
...
class DocumentoDetailSerializer(serializers.ModelSerializer):
    ...
    def get_referencia_detallada(self, obj) -> dict:
        """Devuelve IDs y números de operación origen para navegación."""
        res = {
            "venta_id": obj.venta_id,
            "compra_id": obj.compra_id,
        }
        if obj.venta:
            res["numero"] = obj.venta.numero_documento
        elif obj.compra:
            res["numero"] = obj.compra.numero_compra
        return res
