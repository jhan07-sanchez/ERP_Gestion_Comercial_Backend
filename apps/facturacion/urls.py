...
from apps.facturacion.views.impuesto_views import ImpuestoViewSet
from apps.facturacion.views.resolucion_views import ResolucionViewSet
...
router.register(r'resoluciones', ResolucionViewSet, basename='resolucion')
