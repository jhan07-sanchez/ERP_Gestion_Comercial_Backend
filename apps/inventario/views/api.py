...
class CategoriaViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['get'], permission_classes=[IsAuthenticated, EsSupervisor])
...
class ProductoViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = Producto.objects.select_related('categoria').prefetch_related('inventario')
    ...
    def get_permissions(self):
        ...
        elif self.action in ['activar', 'desactivar', 'stock_bajo', 'estadisticas', 'ajustar_stock']:
    ...
    def ajustar_stock(self, request, pk=None):
        ...
        try:
            ...
            return Response({
                ...
                'stock_anterior': movimiento.cantidad if movimiento.tipo_movimiento == 'SALIDA' else 0,
...
class InventarioViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    @action(detail=False, methods=['get'], permission_classes=[IsAuthenticated, EsSupervisor])
